        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-3/4 lg:w-1/2 max-h-[80vh] font-poppins">
            ...
            <p className="text-base text-justify text-sm leading-relaxed mt-4 mb-4">
              These Terms of Service <strong>(TOS)</strong> govern your registration process...
            </p>

            <p className = "text-sm">Last Updated: <strong>November, 2024</strong></p>
            {/* Terms Content */}
            <div ref={termsContentRef} 
                 className="overflow-auto max-h-[40vh] mt-4 px-4 py-2 border-2 border-tc rounded-lg">
            ...
            <button
              ...
              className={`px-4 py-2 w-3/12 rounded-md shadow-md text-white bg-btnBg hover:bg-gradient-to-br hover:from-accent hover:to-btnBg transform hover:scale-105 mr-2 ${!isTermsScrolledToBottom ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              I Agree
            </button>
              ...
              <button
                ...
                className="px-4 py-2 w-3/12 rounded-md shadow-md text-black border-2 border-tc hover:bg-tc hover:text-background font-poppins text-tc transition-colors duration-300"
              >
                I Disagree
              </button>
