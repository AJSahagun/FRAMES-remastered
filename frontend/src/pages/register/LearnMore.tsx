...
const LearnMore = () => {
  const benefits = [
    {
      ...
      description: "Our face recognition technology ensures your identity is protected and verified securely."
    },
    {
      icon: <FaRegClock className="w-8 h-8 text-primary" />,
      title: "Quick Process",
      description: "Complete your registration in minutes with our streamlined four-step process."
    },
    {
      icon: <FaUsers className="w-8 h-8 text-primary" />,
      title: "User-Friendly",
      description: "Designed for users of all tech levels with clear instructions and support."
    }
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Securely register your face using our advanced recognition system."
    },
    {
      number: "03",
      title: "Verification",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-br from-primary to-accent text-white py-20">
        <div className="container mx-auto px-4">
          <img className="mb-6 px-2 bg-white rounded-md" src="/logos/FRAMES_title-logo.png" alt="FRAMES logo"  />
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                  <span className="text-4xl font-bold text-tc/20">{step.number}</span>
      ...
      <section className="py-16 bg-btnHover text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Access the library seamlessly with FRAMES.</p>
