						...
						<div className="w-1/2 flex flex-col justify-center">
							...
							<div className="flex flex-col items-center mt-12">
								<Field
									...
									className="hidden w-1/3 px-8 py-4 rounded-md bg-accent font-poppins text-white text-lg placeholder:text-lg placeholder:font-poppins  focus:outline-secondary ">		
								</Field>
