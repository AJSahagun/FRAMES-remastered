			...
			<div className="w-full flex flex-row">
				...
				<div className="w-full flex xl:w-1/2 xl:flex-row ">
					<div className="hidden lg:flex">
						{/* rounded rectangle */}
						<div className="hidden xl:flex rounded-[6em] bg-gradient-to-br from-tc to-btnBg
				...
				<div className="w-full flex flex-col xl:w-1/2 font-poppins xl:ml-10 justify-center">
					...
					<div className="xl:flex xl:mx-32">
						<p className="text-tc opacity-80 text-sm xl:text-[0.9rem] mt-16 mb-3">Please sign in to continue</p>
					</div>
